...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/minha-loja.css">
    ...
    <div>
        ...
        <section class="barra-lateral-section hidden" id="avaliacoes">
            ...
            <div id="avaliacoes-header">
                <div class="rating process-rating" data-rating="4" data-slider-index="1">
                ...
                <p>4,7</p>
                <h2>152 avaliações</h2>
            </div>

            <div id="avaliacoes-body">
                <div class="comentario">
                    <h2>Mateus</h2>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Illo voluptates perspiciatis, unde
                        numquam provident, veniam earum sit vero sint odit nesciunt porro? Consectetur incidunt vero
                        neque fuga similique nemo sapiente.</p>
                    <div class="comentario-footer">
                        <div>
                            <span>5</span>
                            <div class="rating process-rating small" data-rating="5">
            ...
            <ul>
                <li>
                    <input type="text" name="name" id="nome-loja" class="info-loja"
                           placeholder="Adicionar nome da loja" value="Lojinha do Mateus">
                </li>
            </ul>
            <ul>
                <li>
                        <textarea type="text" name="name" id="descricao-loja" class="info-loja"
                                  placeholder="Descrição da loja" maxlength="1000"></textarea>
                </li>
            </ul>
            <button type="button" class="botao hidden" id="salvar-dados-loja">Salvar dados</button>

            <input type="hidden" class="default-campo-loja" id="default-nome-loja" value="Lojinha do Mateus">
            <input type="hidden" class="default-campo-loja" id="default-descricao-loja">
        </div>
    </div>
                        ...
                        <div class="produto">
                            ...
                            <div class="input-container">
                                <div>
                                    ...
                                    <input type="number" name="preco" class="preco moeda" disabled value="5.99" />
                                </div>
                                <div>
                                    <input type="number" name="quantidade" class="quantidade" disabled value="3" />
